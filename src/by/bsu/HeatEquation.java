...
public class HeatEquation {
    ...
    public static double phi(double x, double t){ return b*( pow(x, 2) + pow(t, 2));}

    public static double f0(double t){return pow(E, a*t);}
    public static double f1(double t){ return  pow(E, a*(t-1));}
    public static double fx(double x) { return pow(E, -a*x);}
